...
export default function HomePage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSuccessMessage(
        "Feedback submitted successfully. Thanks for helping us improve FeedPulse.",
      );
      setForm(initialForm);
      setErrors({});
    } catch (error) {
      ...
      <div className="page-grid">
        <section className="hero-card">
          ...
          <p className="hero-text">
            Share bugs, product ideas, improvements, or rough edges. Every submission is
            stored, analyzed, and routed into our review workflow.
          </p>
          <ul className="hero-list">
            <li>
              <strong>No login needed</strong>
              Anyone can submit product feedback in a few minutes.
            </li>
            <li>
              <strong>Built for real product teams</strong>
              Each response is categorized and prepared for admin review.
            </li>
            <li>
              <strong>Clear and respectful</strong>
              Leave as much detail as you can. Better detail leads to better decisions.
            </li>
          </ul>
        </section>
        ...
        <section className="form-card">
          <div className="form-header">
            ...
            <p className="form-subtitle">
              A strong submission explains what happened, where it happened, and why it
              matters. The more specific you are, the easier it is to act on it.
            </p>
          </div>
          ...
          <form className="feedback-form" onSubmit={handleSubmit} noValidate>
            <div className="field">
              ...
              <input
                ...
                name="title"
                type="text"
                placeholder="Example: Dashboard needs dark mode"
                value={form.title}
            ...
            <div className="field">
              ...
              <textarea
                id="description"
                name="description"
                placeholder="Describe the issue or request in at least 20 characters."
            ...
            <div className="field">
              ...
              {errors.submitterEmail ? (
                <span className="error-text">{errors.submitterEmail}</span>
              ) : null}
            </div>
            ...
            <div className="submit-row">
              <p className="submit-note">
                By submitting, you are helping the team prioritize what matters most. We only
                use your email if you choose to include it.
              </p>
